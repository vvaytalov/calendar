...
import { CalendarLegend } from '../../../features/schedule-calendar/ui/CalendarLegend';
import { CalendarMonth } from '../../../features/schedule-calendar/ui/CalendarMonth';
...
export const YearCalendar = observer(({ store }: YearCalendarProps) => {
